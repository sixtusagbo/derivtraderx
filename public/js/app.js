...
/* harmony import */ var _countUp_min_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./countUp.min.js */ "./resources/js/countUp.min.js");
...
(function ($) {
  ...
  particlesJS.load('particles-js', 'plugins/particles.json', function () {}); //- Animate on Scroll initialize

  AOS.init(); //- Owl Carousel configs
  ...
  $('#plan-amount').on('change keyup', function () {
    ...
    if (amount >= min) {
      ...
      var profit = percent / 100 * amount;
      var monthlyProfit = profit * (30 / (duration / 24));
      var annualProfit = profit * (365 / (duration / 24));
