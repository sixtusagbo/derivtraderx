        ...
        <div class="accordion my-5" id="faccordion">
            ...
            <div class="accordion-item">
                ...
                <div id="collapseFive" class="accordion-collapse collapse" aria-labelledby="headingFive"
                    data-bs-parent="#faccordion">
                    <div class="accordion-body">
                        <a href="{{ route('login') }}" class="link-primary text-decoration-none">Login</a> to your account
                        using
            ...
            <div class="accordion-item">
                ...
                <div id="collapseSix" class="accordion-collapse collapse" aria-labelledby="headingSix"
                    data-bs-parent="#faccordion">
                    <div class="accordion-body">
                        Minimum withdrawal amounts for Perfect Money and EPayCore are $1. For Litecoin, Dogecoin, Dash and
                        BNB
            ...
            <div class="accordion-item">
                ...
                <div id="collapse14" class="accordion-collapse collapse" aria-labelledby="heading14"
                    data-bs-parent="#faccordion">
                    <div class="accordion-body">
                        Invite your friends and earn money for advertising. We offer 3-tire referral program with
                        commissions.
                    </div>
                </div>
            </div>
