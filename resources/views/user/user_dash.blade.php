            ...
            <div class="row" style="margin-right: -10px;margin-left: -10px;">
                <div class="col-lg-4 col-md-6 col-12">
                    <article class="white-block">
                        ...
                        <div class="overview">
                            <div class="overview-leading">
                                <div class="overview-leading-icon-wrapper bg-secondary text-light">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <article class="white-block p-0">
                        <div class="card mb-0 bg-transparent text-center">
                            <img src="{{ asset('images/user_cover_bg.jpg') }}" class="img-fluid card-img-top"
                                alt="User Cover" style="position: relative">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div class="d-flex flex-column">
                                        <h6 class="text-secondary fw-bold mt-3 mb-2">Total Deposit</h6>
                                        <h4 class="text-light">$0.00</h4>
                                    </div>
                                    <div class="d-flex flex-column">
                                        <h6 class="text-secondary fw-bold mt-3 mb-2">Earning</h6>
                                        <h4 class="text-light">$0.00</h4>
                                    </div>
                                </div>
                            </div>
                        ...
                        <ul class="top-cat-list">
                            ...
                            <li>
                                <a href="##">
                                    ...
                                    <div class="top-cat-list__subtitle">
                                        UX design tips <span class="warning">+472</span>
                                    </div>
                                </a>
                            </li>
                            <li>
