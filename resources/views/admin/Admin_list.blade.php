            ...
            <div class="row stat-cards">
				...
				<div class="col-md-6 col-xl-6">
					<article class="stat-cards-item row">
							...
							<div class="col-3">
								<button type="submit" data-bs-toggle="modal" data-bs-target="#createAdmin" class="btn btn-primary">+ Admin</button>
							</div>
						</article>
                </div>
            </div>
                            ...
                            <div class="modal-dialog">
                              <div class="modal-content">
                                ...
                                <div class="modal-body" id="createAdminModalBody">
                                  <form class="pt-3" role="form" method="POST" action="{{ url('/user/create')}}" id="createAdmin" >
                                    @csrf
